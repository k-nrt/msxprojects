...
%BinPath%\bmp2sprite galaxy.png -o galaxy_sprite.inl
...
sdcc -o "%OutDir%\galaxy.ihx" %Objects% %Libs% %Options% --opt-code-speed
%BinPath%\ihx2bin "%OutDir%\galaxy.ihx" "%OutDir%\galaxy.rom" -offset 16384 -size 32768
