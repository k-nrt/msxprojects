...
PersTransformClipTestX_TestLeft:
	...
	neg
	ld	e,a
	PersTransformUnsignedTest	_s_u8TransformLeft
	ld	a,#0
	ret	nc
	or	#kClipBit_Left
	ret
...
PersTransformClipTestX_TestRight:
	ld	e,a	; e = x
	PersTransformUnsignedTest	_s_u8TransformRight
	ld	a,#0
	ret	nc
	or	#kClipBit_Right
	ret
...
PersTransformClipTestY_TestTop:
	...
	neg
	ld	e,a
	PersTransformUnsignedTest	_s_u8TransformTop
	ld	a,c
	ret	nc
	or	#kClipBit_Top
	ret
...
PersTransformClipTestY_TestBottom:
	ld	e,a		; e = y
	PersTransformUnsignedTest	_s_u8TransformBottom
	ld	a,c
	ret	nc
	or	#kClipBit_Bottom
	ret
