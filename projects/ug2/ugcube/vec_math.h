...
#define s8x3_RotateX(d,s,rot) {s8XY xy=SinCos_RotateXYLp(s.y,s.z,rot); d.y=s8XY_GetX(xy); d.z=s8XY_GetY(xy);}
#define s8x3_RotateY(d,s,rot) {s8XY xy=SinCos_RotateXYLp(s.z,s.x,rot); d.z=s8XY_GetX(xy); d.x=s8XY_GetY(xy);}
#define s8x3_RotateZ(d,s,rot) {s8XY xy=SinCos_RotateXYLp(s.x,s.y,rot); d.x=s8XY_GetX(xy); d.y=s8XY_GetY(xy);}
